...
<div class="container">
    ...
    <div class="row mb-1 mt-2">
        <div class="col">
            <div style="float: right;"><button class="btn btn-outline-danger float-right" type="button" data-bs-toggle="modal" data-bs-target="#modal-novo-usuario"><i class="fa-solid fa-plus"></i> Novo usuário</button></div>
        </div>
    </div>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            if ($row['banido'] == 1) : ?>
                                ...
                                <span class="fw-normal text-danger"><i class="bi bi-x-octagon-fill"></i> Banido</span>
                            <?php else : ?>
                                <!-- <svg class="icon icon-xxs text-success me-1" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"> -->
                                    <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path><span class="fw-normal text-success"><i class="bi bi-check-circle-fill"></i> Ativo</span>
                                <?php endif; ?>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content" style="background-color: black;">
                    ...
                    <form action="adicionar.php?acao=usuario" method="post">
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="text" name="nome" class="form-control" style="background-color: white;">
                            </div>
                            <div class="col">
                                <label for="">Login</label>
                                <input type="text" name="login" class="form-control" style="background-color: white;">
                            </div>
                        </div>
                        ...
                        <div class="row mt-2">
                            ...
                            <div class="col">
                                ...
                                <input type="text" name="pasta_nova" class="form-control" style="background-color: white;">
                            </div>
                        </div>
                        ...
                        <div class="col">
                            Nivel de permissão
                            <select name="nivel" class="form-select" style="background-color: white;">
                ...
                <div class="modal-footer">
                    <button type="submit" name="adicionar_usuario" style="color: white" class="btn btn-outline-danger">Adicionar</button></form>
        ...
        <div class="modal fade" id="modal-editar-usuario" tabindex="-1" role="dialog" aria-labelledby="" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content" style="background-color: black;">
                    ...
                    <div class="modal-body">
                        ...
                        <form action="editar.php?acao=usuarios" method="post">
                            ...
                            <div class="row">
                                <div class="col">
                                    <label for="">Nome</label>
                                    <input type="text" name="nome" value="<?= $dados['nome'] ?>" class="form-control" style="background-color: white;">
                                </div>
                                <div class="col">
                                    <label for="">Login</label>
                                    <input type="text" name="login" value="<?= $dados['login'] ?>" class="form-control" style="background-color: white;">
                                </div>
                            </div>
                            ...
                            <div class="row mt-2">
                                ...
                                <div class="col">
                                    <label for="">Pasta atualização</label>
                                    <input type="text" value="<?= $dados['pasta_att'] ?>" name="pasta_nova" class="form-control" style="background-color: white;">
                                </div>
                            </div>
                    ...
                    <div class="modal-footer">
                        <button type="submit" name="atualiza_usuarios" style="color: white" class="btn btn-outline-danger">Editar</button></form>
                        <button type="button" style="color: white" class="btn btn-outline-danger text-gray ms-auto" data-bs-dismiss="modal">Cancelar</button>
                    </div>
                </div>
            </div>
